    ...
    <div className="flex-1 max-w-2xl w-full mx-auto px-4 py-8 animate-fade-in">
      ...
      <div className="glass-panel-neon-purple p-6 md:p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-xl font-bold text-slate-100">Anthropic Claude API</h3>
            <p className="text-xs text-slate-400">Configuração de chave do Console da Anthropic</p>
          </div>
        </div>
